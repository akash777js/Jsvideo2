...
OWNER_ID = 5830856952 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [5830856952,7856557198,6303334633]
...
@bot.on_message(filters.command(["josim"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[Josim](https://t.me/Tushar0125)"
    if raw_text3 == '1':
        CR = '[Josim](https://t.me/Tushar0125)'
    elif raw_text3:
        try:
